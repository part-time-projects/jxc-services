...
public class TreeModel implements Serializable {
	...
	public TreeModel(BasMaterial basMaterial) {
		this.key = basMaterial.getId();
//		this.icon = basMaterial.getIcon();
		this.parentId = basMaterial.getParentId();
		this.title = basMaterial.getName();
		this.slotTitle =  basMaterial.getName();
		this.value = basMaterial.getId();
		this.isLeaf = basMaterial.isLeaf();
		this.label = basMaterial.getName();
